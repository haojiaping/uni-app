<template>
	<view>
		<view
			...
			:style="{  background: navBgColor, color: navFontColor, opacity: transparentValue , height:haojp,marginTop:hjp}"
		>
			<view class="left_box" style="">
				<slot name="left">
...
//  const height = wx.getMenuButtonBoundingClientRect()
//  console.log(height)
//  this.hjp= height.top
//  this.haojp=height.height
// console.log(this.hjp)
// console.log(this.haojp)
...
// 		(	 (options) => {
  ...
  const heightt = wx.getMenuButtonBoundingClientRect()
 console.log(this.heightt)
 this.hjp= heightt.top+"px"
 this.haojp=heightt.height+'px'
console.log(this.hjp)
// console.log(this.haojp)
